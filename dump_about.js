...
let outStream = fs.createWriteStream('D:\\CDC\\webcq\\next-frontend\\about_extracted.sql');

const targetTables = ['tms_vi_about', 'tms_vi_co_cau_to_chuc_rows', 'tms_vi_page'];
...
rl.on('close', () => {
    console.log("Extraction to about_extracted.sql complete.");
    outStream.close();
});
