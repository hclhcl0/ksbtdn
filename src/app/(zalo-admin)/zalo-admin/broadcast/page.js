                  ...
                  {newsArticles.map((article) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontWeight: 600, fontSize: "0.85rem", color: "var(--text)", marginBottom: "4px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", display: "flex", alignItems: "center", gap: "8px" }}>
                          {article.source === 'website' && (
                            <span style={{ background: "var(--primary-light)", color: "var(--primary)", padding: "2px 6px", borderRadius: "4px", fontSize: "0.7rem", flexShrink: 0 }}>
                              🌐 Website
                            </span>
                          )}
                          {article.source === 'zalo' && (
